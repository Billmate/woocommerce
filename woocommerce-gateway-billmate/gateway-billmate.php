    ...
    function billmate_load_custom_css() {
		...
		function billmate_load_scripts_styles() {
			...
			if($checkout->enabled == 'yes' && is_page($checkout->checkout_url)){
				...
				wp_localize_script( 'billmate-checkout-js', 'billmate', array(
					'ajax_url' => admin_url( 'admin-ajax.php' ),
					'billmate_checkout_nonce' => wp_create_nonce('billmate_checkout_nonce'),
					'overlay_enabled' => get_option('billmate_common_enable_overlay')
				));
			}
